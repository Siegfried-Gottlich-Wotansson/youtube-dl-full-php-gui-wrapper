                                ...
                                <div class="col-lg-8 mx-auto text-left">
                                    <div class="form-group">
                                        <div id="form" class="form-group has-feedback">
                                            <label id="statuslabel" class="control-label">Just paste your link or type a song name</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"> <i class="fa fa-youtube"></i></span>
                                                <input type="text" class="form-control" id="ylink" value="<?= $get_id ?>" placeholder="Example: 'metallica fade to black'" />
